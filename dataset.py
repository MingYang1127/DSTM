...
def docred_convert_examples_to_features(
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        dependency_graph = ex_index2graph[ex_index]
...
class DocREDInputFeatures(object):
    ...
    def __init__(self, input_ids, attention_mask, token_type_ids, ent_mask, ent_ner, ent_pos, ent_distance, structure_mask, label=None, label_mask=None, adj=None):
